...
forward_schedule = [(1e-4, 10_000,  128),    # progressive training schedule
                    (1e-4, 300_000,  128),   # (lr, step, batch_size)
                    (2e-5, 600_000,  128)]   # (lr, step, batch_size)
